...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      <a
        href="/"
        className="absolute left-8 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full glass-surface border border-white/5 flex items-center justify-center hover:border-primary/50 transition-colors z-20"
      >
            ...
            <div className="relative">
              ...
              >
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2 12C3.8 8.8 7.2 6 12 6C16.8 6 20.2 8.8 22 12C20.2 15.2 16.8 18 12 18C7.2 18 3.8 15.2 2 12Z" fill="white" stroke="black" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                  {showPassword ? (
                    <circle cx="12" cy="12" r="3" fill="white" stroke="black" strokeWidth="1.8" />
                  ) : (
                    <path d="M5 19L19 5" stroke="black" strokeWidth="2" strokeLinecap="round" />
                  )}
                </svg>
              </button>
            </div>
